      ...
      <main class="container" style="padding-top:30px; align-left">
        ...
        <div class="row">
          <div class="col-6" {{$errors->has('kecamatan_id') ? ' has-error' : ''}}>
            ...
            <input class="form-control" id="kec_id" name="kecamatan_id" value="" type="text"
              placeholder="Nama Kecamatan" aria-label="Disabled input example">
          ...
          <div class="col-6" {{$errors->has('desa_id') ? ' has-error' : ''}}>
            <div class="mb-3">
              ...
              <input class="form-control" id="des_id" name="desa_id" type="text" placeholder="Nama Desa"
        ...
        {{-- <div class="form-group {{$errors->has('kegiatan_id') ? ' has-error' : ''}}">
          ...
          <input class="form-control" onselect="getData" value="{{old('kegiatan_id')}}" list="datalistOptions"
            id="exampleDataList" placeholder="Enter kegiatan" name="kegiatan_id" onchange="renderDataList()">
        ...
        {{-- <div class="form-group {{$errors->has('mitrabaru_id') ? ' has-error' : ''}}">
          ...
          <input class="form-control" value="{{old('mitrabaru_id')}}" list="datalistOptions1" id="exampleDataList1"
