...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('template/assets/css/argon-dashboard.min.css')}}" rel="stylesheet" />
</head>

<body class="g-sidenav-show bg-info">
  <div class="min-height-300 bg-primary position-absolute w-100">
    <img src="{{asset('template/assets/img/sensus2.png')}}" class="img-responsive center-block d-block mx-auto"
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="/tambahkegiatan" class="nav-link">
